...
// this method will allocate a lot of addition process memory
// this method will only search for unquoted service paths outside of \Windows\ directory
...
// to restore the backup, rename "sethc_backup.exe" back to "sethc.exe"
